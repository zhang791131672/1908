        ...
        <table>
            <tr>
                <td width="50%">
                    ...
                    <time>创建日期：{{date('Y-m-d h:i:s',$OrderInfo->order_time)}}<br />
                        失效日期：2015-9-12</time>
                    <strong class="orange">¥{{$OrderInfo->order_money}}</strong>
                </td>
...
<div class="gwcpiao">
    <table>
        <tr>
            ...
            <td width="50%"><a href="/payMoney/{{$OrderInfo->order_no}}" class="jiesuan">立即支付</a></td>
        </tr>
    </table>
</div><!--gwcpiao/-->
</div><!--maincont-->
